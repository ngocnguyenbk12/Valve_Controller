...
#define CC_SUPERVISION_COMMAND_PROPERTIES_SESSION_ID_BITMASK         0x3F
#define CC_SUPERVISION_COMMAND_PROPERTIES_RESERVED_BITMASK           0x40
#define CC_SUPERVISION_COMMAND_PROPERTIES_MORE_STATUS_UPDATE_BITMASK 0x80

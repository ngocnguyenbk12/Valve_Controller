...
notification_status_set_t;

typedef notification_status_set_t NOTIFICATION_STATUS_SET;
 ...
 */
extern BOOL handleAppNotificationSet(
...
/**
 * @brief Handler for command class Notification
 ...
 */
extern BOOL FindNotificationEndpoint(NOTIFICATION_TYPE notificationType, uint8_t * pEndpoint);
